      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
          <motion.div
            role="dialog"
            aria-modal="true"
            aria-labelledby="bake-delete-confirm-title"
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            className="bg-white dark:bg-crust-900 rounded-2xl p-6 max-w-sm w-full shadow-xl"
          >
            <h3 id="bake-delete-confirm-title" className="text-lg font-display font-semibold text-crust-800 dark:text-crumb-100 mb-2">
